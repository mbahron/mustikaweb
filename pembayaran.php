      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">Bayar Disini</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
	                	<label for="streetaddress">Desa atau Kelurahan</label>
	                  <input type="text" class="form-control" placeholder="">
	                </div>
		            </div>
		            <div class="col-md-6">
		            	<div class="form-group">
	                  <input type="text" class="form-control" placeholder="Dusun (RT/RW)">
	                </div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
		            		<label for="postcodezip">Kabupaten atau Kota</label>
	                  <input type="text" class="form-control" placeholder="">
	                </div>
		            </div>
		            <div class="w-100"></div>
                ...
                <div class="col-md-12">
                	<div class="form-group mt-4">
										<div class="radio">
										  <label class="mr-3"><input type="radio" name="optradio"> Buat akun baru?</label>
	          		...
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4"> Metode Pembayaran</h3>
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2">Melalui Cek</label>
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<p><a href="#"class="btn btn-primary py-3 px-4">Mulai memesan</a></p>
								</div>
	          	</div>
	          </div>
          </div> <!-- .col-md-8 -->
